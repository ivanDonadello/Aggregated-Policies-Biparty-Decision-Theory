...
if __name__ == "__main__":
    ...
    print(f'>> Running propagation experiments using [{dataset_name}] dataset')
    ...
    print(f'\n>> Adding Acceptance rate results in the dataset')
    ...
    print(f'\n>> Generating metrics results for [{dataset_name}] dataset')
